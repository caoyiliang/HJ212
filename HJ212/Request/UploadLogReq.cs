...
{
    internal class UploadLogReq(string mn, string pw, ST st, int flag, DateTime dataTime, string? polId, string log) : IAsyncRequest
    {
        ...
        public byte[] ToBytes()
        {
            var rs = $"QN={_QN};ST={(int)st};CN=3020;PW={pw};MN={mn};Flag={flag};CP=&&DataTime={dataTime:yyyyMMddHHmmss};{(polId == null ? "" : $"PolId ={polId};")}i11001-Info=//";

...
{
    internal class GetElectricityMonitoringRealTimeDataRsp : IAsyncResponse<(DateTime BeginTime, DateTime EndTime, RspInfo RspInfo)>
    {
        ...
        public async Task AnalyticalData(byte[] bytes)
        {
            ...
            {
                throw new ArgumentException($"HJ212 Get ElectricityMonitoringRealTimeData BeginTime Error");
            }
            ...
            {
                throw new ArgumentException($"HJ212 Get ElectricityMonitoringRealTimeData EndTime Error");
            }
